...
typedef std::tuple<
        ...
        CommonTestUtils::SizeVector, // Input Shape
        TargetDevice                 // Target Device
> basicParamsNew;
...
protected:
    ...
    virtual ov::Tensor GenerateInput(ov::element::Type prc, const ov::Shape& shape) const;
    ...
    ov::Layout inLayout = "";
    ov::Layout outLayout = "";
    ov::element::Type_t inPrc = ov::element::Type_t::undefined;
    ov::element::Type_t outPrc = ov::element::Type_t::undefined;
    ...
    virtual std::vector<ov::Tensor> GetOutputs();
